 ...
 *
 * Activated only when {@code app.mail.enabled=true}.
 * When disabled, ConsoleEmailService is used instead.
 *
 * In production, set:
 ...
 *   app.mail.from=MindQ <you@gmail.com>
 *
 * NEVER log OTP values in this service.
 */
@Slf4j
@Service
@Profile("!test")
...
public class SmtpEmailService implements EmailService {
    ...
    public SmtpEmailService(
            ...
            @Value("${app.mail.from:MindQ <noreply@mindq.app>}") String fromAddress) {
