  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--mq-bg)] px-5">
      <div className="text-center">
        <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-3xl bg-[var(--mq-primary-light)] text-[var(--mq-primary)]">
          <SearchX size={36} />
        </div>

        <h1 className="text-6xl font-bold text-[var(--mq-text)]">404</h1>
